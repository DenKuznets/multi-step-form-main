...
const layout = ({ params, children }: LayoutProps) => {
    ...
    return (
        <main className="relative flex min-h-screen flex-[1] flex-col items-center rounded-xl sm:m-auto sm:h-[37.5rem] sm:min-h-[unset] sm:max-w-[59rem] sm:flex-row sm:items-start sm:bg-white sm:p-4">
            <StepsList />
            <div className="step relative top-[-5rem] mx-4 sm:mx-0 sm:pt-10 sm:px-20 sm:top-0 sm:h-full sm:w-full sm:p-0">
